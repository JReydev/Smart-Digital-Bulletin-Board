...
// Sort announcements by effective date
            ...
            <div class="announcement" data-id="<?php echo htmlspecialchars($announcement['id']); ?>">
                ...
                <div class="meta">
                    ...
                    <div class="actions">
                        ...
                        <button onclick="event.stopPropagation(); showDeleteConfirmation(<?= $index ?>)" title="Delete Announcement">
    ...
    <div class="popup-wrapper">
        <div class="popup-content">
            ...
            <div class="popup-body">
                ...
                <div class="announcement-title" id="deleteTitle"></div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/Sortable/1.15.0/Sortable.min.js" integrity="sha512-+8Jx5o3p5e3qk6m8Xj0lG8h7bXW1J8r9GmNw1g3v1u2k4u3w5ZbqXzjv1Q1fZ3pQ2eO+8bYpR6wqk3V7uKzBWA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
    ...
    let deleteAnnouncementIndex = -1;

    function showDeleteConfirmation(index) {
        event.stopPropagation();
        deleteAnnouncementIndex = index;
        const ann = announcements[index];
        
        document.getElementById("deleteTitle").textContent = ann.title;
    ...
    function confirmDelete() {
        if (deleteAnnouncementIndex === -1) return;
        
        const ann = announcements[deleteAnnouncementIndex];
            showLoading();
            ...
            fetch('delete_announcement.php', {
                ...
                body: `id=${encodeURIComponent(ann.id)}`
            })
            .then(response => {
                if (!response.ok) {
                    throw new Error('Network response was not ok');
            ...
            .catch(error => handleError(error, 'Failed to delete announcement. Please try again.'));
        }
    ...
    // Update the delete button click handler in announcements
    const deleteButtons = document.querySelectorAll('.announcement .actions button:last-child');
    deleteButtons.forEach((button, index) => {
        button.onclick = (e) => showDeleteConfirmation(index);
    });
            ...
            new Sortable(container, {
                ...
                onEnd: async function(evt) {
                    ...
                    try {
                        ...
                        // Revert to original order if needed
                        location.reload();
                    }
                }
            });
